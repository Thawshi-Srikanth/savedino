    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success:
            "group-[.toaster]:border-emerald-500/30 group-[.toaster]:bg-card",
          error:
            "group-[.toaster]:border-destructive/30 group-[.toaster]:bg-card",
          info:
            "group-[.toaster]:border-sky-500/30 group-[.toaster]:bg-card",
          warning:
            "group-[.toaster]:border-amber-500/30 group-[.toaster]:bg-card",
        },
      }}
      {...props}
    />
