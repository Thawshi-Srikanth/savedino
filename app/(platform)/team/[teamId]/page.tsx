    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <Card className="p-5 sm:p-6 bg-card border-border space-y-4 shadow-arcade rounded-2xl">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          {/* Quick Actions (Discord Thread & Invite Code) */}
          <div className="flex flex-wrap items-center gap-2.5">
            {team?.discordThreadUrl && (
              <Button
                ...
                size="sm"
                variant="outline"
                className="h-9 px-3 text-xs font-bold rounded-xl border-[#5865F2]/40 text-[#5865F2] hover:bg-[#5865F2]/10 shadow-arcade active:translate-y-0.5 cursor-pointer"
              >
                <a
