        ...
        <div className="w-full bg-card border border-border shadow-xl rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            <Button
              ...
              className="h-11 text-xs font-sans font-semibold flex items-center justify-center gap-2 border-border bg-background hover:bg-muted transition-colors cursor-pointer"
            >
